...
function Home() {
  return (
    <motion.section
      id="home" // ✅ Add this line for react-scroll targeting
      initial={{ opacity: 0, y: 50 }}
      animate={{ opacity: 1, y: 0 }}
      transition={{ duration: 1 }}
      className="pt-16 flex flex-col items-center justify-center h-screen bg-gradient-to-r from-purple-500 to-pink-500 text-white"
    >
